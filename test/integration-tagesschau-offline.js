        ...
        suite('Test adapter with German news configuration - offline data mode', (getHarness) => {
            ...
            it('should create connection state and start adapter with offline data', () => new Promise(async (resolve, reject) => {
                ...
                harness.objects.getObject('system.adapter.tagesschau.0', async (err, obj) => {
                    ...
                    await new Promise(res => setTimeout(res, 20000));              // ...existing code...
                    ...
                    let connectionState;
                    try {
                        connectionState = await new Promise((resolve, reject) => {
                    ...
                    try {
                        // Get all state IDs matching the pattern
                        ...
                        if (!stateIds || stateIds.length === 0) {
                            ...
                            return reject(new Error('No states found matching pattern tagesschau.0.*'));
                        }

                        // Get all states for these IDs
